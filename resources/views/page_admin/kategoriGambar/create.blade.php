          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Form Tambah Kategori Gambar</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Form Tambah Kategori Gambar</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row justify-content-center">
        <div class="col-sm-6">
          <div class="card">
            ...
            <div class="card-body">
              <form action="{{ route('kategoriGambar.store') }}" method="POST">
                @csrf
                <div class="form-group mb-3">
                  <label for="kategori_gambar" class="form-label">Kategori Gambar</label>
                  <input type="text" class="form-control @error('kategori_gambar') is-invalid @enderror" id="kategori_gambar" name="kategori_gambar" value="{{ old('kategori_gambar') }}" placeholder="Masukkan kategori gambar">
