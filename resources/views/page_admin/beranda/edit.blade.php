                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="judul_utama"
                                                ...
                                                value="{{ old('judul_utama', $beranda->judul_utama) }}" required>
                                            @error('judul_utama')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="judul_sekunder"
                                                class="form-control @error('judul_sekunder') is-invalid @enderror"
                                                value="{{ old('judul_sekunder', $beranda->judul_sekunder) }}" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="slogan"
                                                ...
                                                value="{{ old('slogan', $beranda->slogan) }}" required>
                                            @error('slogan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="gambar_sekunder"
