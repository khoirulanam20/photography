...
<body class="webpage">
    ...
    <!-- Bootstrap JS Bundle (untuk Tooltip) -->
    ...
    <style>
        ...
        .whatsapp-wrapper:focus-within .whatsapp-button {
        ...
        .whatsapp-wrapper:focus-within .whatsapp-tooltip {
            opacity: 1;
            visibility: visible;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            function initTooltips() {
                ...
                tooltipTriggerList.forEach(function(tooltipTriggerEl) {
                    ...
                    var preferredPlacement = tooltipTriggerEl.getAttribute('data-bs-placement') || 'auto';
                    var fallbackPlacements = preferredPlacement === 'top' ? ['bottom'] : ['top', 'right',
                        'bottom', 'left'
                    ];
                    var verticalOffset = preferredPlacement === 'top' ? 14 : 8;
                    ...
                    var tooltip = new bootstrap.Tooltip(tooltipTriggerEl, {
                        ...
                        popperConfig: function(defaultBsPopperConfig) {
                            defaultBsPopperConfig.modifiers = (defaultBsPopperConfig
                                .modifiers || []).concat([{
                                    name: 'offset',
                                    options: {
                    ...
                    tooltipTriggerEl.addEventListener('shown.bs.tooltip', function() {
                        ...
                        if (tooltipElement) {
                            ...
                            tooltipElement.style.padding = '14px 20px';
            ...
            window.addEventListener('scroll', function() {
                ...
                whatsappWrapper.style.bottom = scrollPosition > 100 ? '80px' : '20px';
            });
        });
    </script>
    @php
    ...
    @if ($noWa)
        <div class="whatsapp-wrapper">
            <a href="https://wa.me/{{ $noWa }}" class="whatsapp-button" aria-label="Hubungi Kami via WhatsApp">
